...
function ProductQuantityButton({ productId, quantity, onClick }) {
  return (
    <div className="flex w-16 h-12 px-2 py-1 gap-1 md:px-4 md:py-3 md:h-12 md:gap-2 justify-center items-center bg-color-hover-cancel-button rounded-full">
      {quantity}
